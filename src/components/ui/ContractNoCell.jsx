import ConfidentialMark from './ConfidentialMark';
...
// line, remark de-emphasized and non-mono so it doesn't read as part of the code, plus
// the "!" confidential mark (see ConfidentialMark.jsx) right after Contract No. when
// applicable. Contract No. itself never truncates or wraps (shrink-0 + whitespace-nowrap
// — the column is sized with enough room for the full number) — if the cell is too
// narrow for both, the remark truncates with an ellipsis + hover tooltip instead of
// wrapping onto its own line. Renders nothing but this content — the caller still owns
// its own <td> (padding/alignment can differ per table).
